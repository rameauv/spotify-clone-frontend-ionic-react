...
describe('settings', {
  ...
  it('should navigate to the settings page from the library tab and chagen the profile name to nameChanged', () => {
    ...
    //cy.get('.profile-settings_ionContent__5wkpg', {includeShadowDom: true}).shadow().find('.inner-scroll').scrollTo(0, {duration: 5000});
    cy.get('.round-outline-button_editButton__z6fol').click({scrollBehavior: false});
    cy.get('.edit-profile-modal_profileTitleInput__vJVXc').type(newName);
